...
public class CastlingMoveTest {
    ...
    public void testDefsCreation() {
        assertThat(createCastlingMove(WHITE_LONG, CASTLING_WHITE_LONG, 4, 2, 0, 3))
                .isEqualTo(castlingWhiteLong);

        assertThat(createCastlingMove(WHITE_SHORT, CASTLING_WHITE_SHORT, 4, 6, 7, 5))
                .isEqualTo(castlingWhiteShort);

        assertThat(createCastlingMove(BLACK_LONG, CASTLING_BLACK_LONG, 60, 58, 56, 59))
                .isEqualTo(castlingBlackLong);

        assertThat(createCastlingMove(BLACK_SHORT, CASTLING_BLACK_SHORT, 60, 62, 63, 61))
